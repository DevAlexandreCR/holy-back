...
import { ensureSettings, setPreferredVersion, setTimezone } from './userSettings.service';
...
const formatSettings = (settings: { preferredVersionId: number | null; timezone: string | null }) => ({
